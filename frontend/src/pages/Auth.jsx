  ...
  const validateForm = () => {
    ...
    if (!isLogin) {
      ...
      if (!formData.aadhaarNumber.trim()) {
        newErrors.aadhaarNumber = 'Ghana number is required';
      } else if (!/^\d{10}$/.test(formData.aadhaarNumber)) {
        newErrors.aadhaarNumber = 'Ghana card Number must be 10 digits';
      }
            ...
            <div className="w-full max-w-md mx-auto">
              <div className="absolute top-6 right-8">
                <div className="flex items-center">
                  ...
                  <h1 className="text-xl font-bold text-gray-900">RecycleAura</h1>
                </div>
              </div>
